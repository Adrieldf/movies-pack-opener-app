...
export type PackType = "movies" | "games" | "music" | "anime" | "pokemon" | "boardgame" | "giphy" | "yugioh" | "mtg" | "disney" | "digimon" | "lorcana" | "countries" | "pokemontcg" | "ghibli" | "dragonball" | "ero" | "numbers" | "random";
  ...
  const topFoilContent = (
    <div className="w-full h-full flex flex-col pointer-events-none">
      ...
      <div className={`w-full flex-1 ${packType === 'games' ? 'bg-gradient-to-b from-blue-700 via-indigo-900 to-blue-900 border-blue-400/30' : packType === 'music' ? 'bg-gradient-to-b from-green-600 via-emerald-800 to-green-950 border-green-400/30' : packType === 'anime' ? 'bg-gradient-to-b from-pink-700 via-rose-900 to-pink-950 border-pink-400/30' : packType === 'pokemon' ? 'bg-gradient-to-b from-yellow-700 via-red-900 to-yellow-950 border-yellow-400/30' : packType === 'boardgame' ? 'bg-gradient-to-b from-amber-700 via-orange-900 to-amber-950 border-amber-400/30' : packType === 'giphy' ? 'bg-gradient-to-b from-cyan-700 via-blue-900 to-cyan-950 border-cyan-400/30' : packType === 'yugioh' ? 'bg-gradient-to-b from-amber-700 via-orange-900 to-amber-950 border-amber-400/30' : packType === 'mtg' ? 'bg-gradient-to-b from-slate-900 via-purple-950 to-black border-purple-500/30' : packType === 'disney' ? 'bg-gradient-to-b from-blue-600 via-indigo-900 to-slate-950 border-blue-400/40 shadow-[inset_0_0_40px_rgba(59,130,246,0.2)]' : packType === 'digimon' ? 'bg-gradient-to-b from-orange-700 via-yellow-900 to-orange-950 border-orange-400/30' : packType === 'lorcana' ? 'bg-gradient-to-b from-yellow-700 via-amber-800 to-yellow-950 border-yellow-400/30' : packType === 'countries' ? 'bg-gradient-to-b from-emerald-700 via-teal-900 to-emerald-950 border-emerald-400/30' : packType === 'pokemontcg' ? 'bg-gradient-to-b from-blue-700 via-blue-900 to-yellow-900 border-yellow-400/30' : packType === 'ghibli' ? 'bg-gradient-to-b from-sky-600 via-green-700 to-green-950 border-sky-400/30 shadow-[inset_0_0_40px_rgba(52,211,153,0.2)]' : packType === 'dragonball' ? 'bg-gradient-to-b from-orange-600 via-red-700 to-red-950 border-orange-400/30 shadow-[inset_0_0_40px_rgba(239,68,68,0.2)]' : packType === 'ero' ? 'bg-gradient-to-b from-fuchsia-700 via-rose-900 to-fuchsia-950 border-fuchsia-400/30 shadow-[inset_0_0_40px_rgba(236,72,153,0.3)]' : packType === 'numbers' ? 'bg-gradient-to-b from-indigo-700 via-violet-900 to-indigo-950 border-indigo-400/30 shadow-[inset_0_0_40px_rgba(129,140,248,0.2)]' : 'bg-gradient-to-b from-slate-800 to-slate-900 border-slate-700/50'} relative overflow-hidden border-b shadow-inner`}>
        ...
        {packType === 'ero' && <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,_rgba(236,72,153,0.6),_transparent)] opacity-40"></div>}
        {packType === 'numbers' && <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,_rgba(129,140,248,0.5),_transparent)]"></div>}
  ...
  return (
    ...
    >
      <div className="relative w-full h-full flex flex-col group drop-shadow-2xl">
        ...
        {/* BOTTOM MAIN BODY */}
        <div className={`h-3/4 w-full ${packType === 'games' ? 'bg-gradient-to-b from-blue-900 via-indigo-950 to-black' : packType === 'anime' ? 'bg-gradient-to-b from-pink-900 via-rose-950 to-black' : packType === 'pokemon' ? 'bg-gradient-to-b from-yellow-900 via-red-950 to-black' : packType === 'boardgame' ? 'bg-gradient-to-b from-amber-900 via-orange-950 to-black' : packType === 'giphy' ? 'bg-gradient-to-b from-cyan-900 via-blue-950 to-black' : packType === 'yugioh' ? 'bg-gradient-to-b from-amber-800 via-orange-950 to-black' : packType === 'mtg' ? 'bg-gradient-to-b from-slate-900 via-purple-950 to-black' : packType === 'disney' ? 'bg-gradient-to-b from-blue-900 via-slate-900 to-black' : packType === 'digimon' ? 'bg-gradient-to-b from-orange-900 via-amber-950 to-black' : packType === 'lorcana' ? 'bg-gradient-to-b from-yellow-800 via-amber-950 to-black' : packType === 'countries' ? 'bg-gradient-to-b from-emerald-900 via-teal-950 to-black' : packType === 'pokemontcg' ? 'bg-gradient-to-b from-yellow-900 via-blue-950 to-black' : packType === 'ghibli' ? 'bg-gradient-to-b from-green-900 via-sky-950 to-black' : packType === 'dragonball' ? 'bg-gradient-to-b from-red-900 via-orange-950 to-black' : packType === 'ero' ? 'bg-gradient-to-b from-fuchsia-950 via-rose-950 to-black' : packType === 'numbers' ? 'bg-gradient-to-b from-indigo-900 via-violet-950 to-black' : 'bg-gradient-to-b from-slate-800 to-black'} relative rounded-b-lg overflow-hidden shadow-2xl border-t ${packType === 'games' ? 'border-blue-400/50' : packType === 'anime' ? 'border-pink-400/50' : packType === 'pokemon' ? 'border-yellow-400/50' : packType === 'boardgame' ? 'border-amber-400/50' : packType === 'giphy' ? 'border-cyan-400/50' : packType === 'yugioh' ? 'border-amber-500/50' : packType === 'mtg' ? 'border-purple-500/30' : packType === 'disney' ? 'border-blue-500/40 shadow-[inset_0_20px_40px_rgba(59,130,246,0.1)]' : packType === 'digimon' ? 'border-orange-400/50' : packType === 'lorcana' ? 'border-yellow-400/50' : packType === 'countries' ? 'border-emerald-400/50' : packType === 'pokemontcg' ? 'border-blue-500/50' : packType === 'ghibli' ? 'border-sky-400/50' : packType === 'dragonball' ? 'border-orange-400/50' : packType === 'ero' ? 'border-fuchsia-500/50 shadow-[inset_0_20px_40px_rgba(236,72,153,0.15)]' : packType === 'numbers' ? 'border-indigo-400/50 shadow-[inset_0_20px_40px_rgba(129,140,248,0.15)]' : 'border-slate-700'}`}>
          ...
          {packType === "games" ? (
            ...
            <div className="absolute inset-0 flex items-center justify-around opacity-20 px-4 pointer-events-none mix-blend-overlay">
              {Array.from({ length: 8 }).map((_, i) => (
                <div key={`heart-${i}`} className="w-4 h-4 bg-rose-400 rounded-full animate-pulse" style={{ position: 'absolute', left: `${Math.random() * 100}%`, top: `${Math.random() * 100}%` }}></div>
              ))}
            </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6">
            {packType === "games" ? (
              ...
              <div className="relative flex flex-col items-center justify-center">
                <div className="w-24 h-24 bg-rose-600 rounded-full shadow-[0_0_40px_rgba(236,72,153,0.6)] relative border-4 border-fuchsia-400 flex items-center justify-center overflow-hidden animate-[pulse_2s_infinite]">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,_rgba(255,255,255,0.2),_transparent)]"></div>
                  <span className="text-5xl filter drop-shadow-[0_0_15px_rgba(255,255,255,0.8)] z-10">💋</span>
                </div>
              </div>
            ) : packType === "numbers" ? (
              <div className="relative flex items-center justify-center">
                {/* Lottery ball illustration */}
                <div className="w-28 h-28 bg-gradient-to-br from-white via-indigo-100 to-indigo-300 rounded-full shadow-[0_15px_30px_rgba(0,0,0,0.8)] relative border-4 border-indigo-400 flex items-center justify-center overflow-hidden animate-[spin_9s_linear_infinite]">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_25%,_rgba(255,255,255,0.9),_transparent_55%)]"></div>
                  <span className="text-4xl font-black text-indigo-900 font-mono drop-shadow-[0_2px_2px_rgba(0,0,0,0.2)] z-10">7</span>
                </div>
                <div className="absolute w-36 h-36 rounded-full border border-indigo-400/20 animate-ping"></div>
                <div className="absolute w-44 h-44 rounded-full border border-violet-300/10"></div>
              </div>
            ) : (
